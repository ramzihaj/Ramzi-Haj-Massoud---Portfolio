...
const socials = [
  {
    label: "GitHub",
    href: "https://github.com/ramzihaj",
  },
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/ramzi-haj-massoud-222513368",
  },
];
      ...
      <div className="container">
        <div className="lg:grid lg:grid-cols-2">
          <div className="mb-10">
            ...
            <ButtonPrimary
              href="mailto:ramzi.hajmaasoud.10@gmail.com"
              label="Start project"
              icon="chevron_right"
              classes="reveal-up"
            />
            ...
            <div>
              ...
              <div className="flex items-center justify-between pt-10 mb-8 reveal-up">
                  ...
                  <p className="text-zinc-500 text-sm reveal-up">
                      &copy; 2025 <span className="text-zinc-200">ramzi.hajmassoud</span>
                  </p>
              </div>
      </div>
    </footer>
